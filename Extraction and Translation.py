...
doc = fitz.open(r"VTU Circular.pdf") #---------> Specify the input file
new_pdf_path = r"Translated.pdf" #-----------> Specify the output file

#Specify the file path here
docf = 'Translated' #-----------------> new_pdf_path ***but without extension***
